...
const Sidebar = () => {
  return (
    <nav className="block py-4 px-6 top-0 bottom-0 w-64 border border-gray-500 shadow-xl left-0 absolute flex-row flex-nowrap md:z-10 z-9999 transition-all duration-300 ease-in-out transform md:translate-x-0 -translate-x-full">
